...
const students = ref<Student[]>([
  ...
  },
  {
    ...
    skills: ["Python", "OpenCV", "TypeScript"],
    github_username: "nikolas_kenzie"
  }
])
    ...
    <div class="max-w-md mx-auto mb-12 ">
      <div class="rounded-md shadow-sm ">
        <input v-model="searchQuery" type="text" placeholder="Type to search..."
          class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm transition ease-in-out duration-150 text-gray-900" />
      </div>
    </div>
      ...
      <div v-for="student in filteredStudents" :key="student.nim"
        ...
        <div class="p-6">
          ...
          <div class="space-y-2 text-sm text-gray-600 mb-4">
            <!-- <p>
              <span class="font-semibold text-gray-700">Major:</span> {{ student.major }}
            </p> -->
            <p>
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-100">
          <a :href="`https://github.com/${student.github_username}`" target="_blank" rel="noopener noreferrer"
